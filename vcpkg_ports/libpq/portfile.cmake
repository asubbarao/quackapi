# The pinned port's client-only Makefile skips PostgreSQL's generated frontend
# headers, so this overlay keeps its port logic while supplying the corrected wrapper.
get_filename_component(_UPSTREAM_LIBPQ_PORT_DIR "${CMAKE_CURRENT_LIST_DIR}/../../vcpkg/ports/libpq" ABSOLUTE)
...
vcpkg_extract_source_archive(
    ...
    ARCHIVE "${ARCHIVE}"
    PATCHES
        "${_UPSTREAM_LIBPQ_PORT_DIR}/unix/installdirs.patch"
        "${_UPSTREAM_LIBPQ_PORT_DIR}/unix/fix-configure.patch"
        "${_UPSTREAM_LIBPQ_PORT_DIR}/unix/single-linkage.patch"
        "${_UPSTREAM_LIBPQ_PORT_DIR}/unix/no-server-tools.patch"
        "${_UPSTREAM_LIBPQ_PORT_DIR}/unix/mingw-install.patch"
        "${_UPSTREAM_LIBPQ_PORT_DIR}/unix/python.patch"
        "${_UPSTREAM_LIBPQ_PORT_DIR}/windows/macro-def.patch"
        "${_UPSTREAM_LIBPQ_PORT_DIR}/windows/win_bison_flex.patch"
        "${_UPSTREAM_LIBPQ_PORT_DIR}/windows/msbuild.patch"
        "${_UPSTREAM_LIBPQ_PORT_DIR}/windows/spin_delay.patch"
        "${_UPSTREAM_LIBPQ_PORT_DIR}/windows/tcl-9.0-alpha.patch"
        "${_UPSTREAM_LIBPQ_PORT_DIR}/android/unversioned_so.patch"
)
...
if(VCPKG_DETECTED_MSVC)
    ...
    include("${_UPSTREAM_LIBPQ_PORT_DIR}/build-msvc.cmake")
...
configure_file("${_UPSTREAM_LIBPQ_PORT_DIR}/vcpkg-cmake-wrapper.cmake" "${CURRENT_PACKAGES_DIR}/share/postgresql/vcpkg-cmake-wrapper.cmake" @ONLY)
...
file(INSTALL "${_UPSTREAM_LIBPQ_PORT_DIR}/usage" DESTINATION "${CURRENT_PACKAGES_DIR}/share/${PORT}")
